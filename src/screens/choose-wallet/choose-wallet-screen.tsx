...
> = observer(function ChooseWalletScreen() {
  ...
  const onSubmit = async data => {
    setLoading(true);
    try {
      const loadedWallet = await StoredWallet.loadFromStorage(
        data.walletName,
        data.walletPassword,
      );
      ...
      getKCData()
        .then(async keyData => {
          ...
          const indexFound = wallets.findIndex(
            ...
            <View style={CONTAINER}>
              <View>
                ...
                <Text style={[NORMAL_TEXT, TEXT_CENTTER]}>
                  Your wallets are currently locked. Select the wallet you wish
                  to access then press the fingerprint icon or provide the
                  password.
                </Text>
              </View>
              <View>
